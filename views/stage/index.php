...
<body>
    ...
    {
        ?>
            <a href="index.php?page=stage/ajouter"  style="float: right;margin-right:10px;height:30px" data-toggle="tooltip" data-placement="top" title="Ajouter" name="ajouter" type="submit" class="btn"><i class="material-icons">add_circle_outline</i></a>
            <?php
    }
    ?>
    ...
    <div class='container'>
        <div class='matable' style="margin-top: 80px;">
            <caption>
                <h3 style="text-align:center; color:#e74c3c">Liste Des Stages</h3>
            </caption>
                    ...
                    <?php
                        foreach( $liste as $stage )
                        {
                            echo "<tr>";
                                ...
                                echo "</td>";
                                echo "<td style='text-align:center'>";
                                    echo $stage->idsociete;
                                echo "</td>";
                                echo "<td style='text-align:center'>";
                                    echo $stage->idencadreur;
                                echo "</td>";
                                echo "<td style='text-align:center'>";
                                    echo $stage->idlaureat;
                                echo "</td>";
