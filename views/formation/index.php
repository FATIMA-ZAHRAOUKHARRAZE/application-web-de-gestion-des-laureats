...
<body>
    ...
    {
        ?>
            <a href="index.php?page=formation/ajouter"  data-toggle="tooltip" data-placement="top" title="Ajouter" style="float: right;margin-right:10px;height:30px" name="ajouter" type="submit" class="btn"><i class="material-icons">add_circle_outline</i></a>
            <?php
    }
    ?>
        ...
        <div class='container'>
            <div class='matable' style="margin-top: 80px;">
                <caption>
                    <h3 style="text-align:center; color:#e74c3c">Liste Des Formations</h3>
                </caption>
